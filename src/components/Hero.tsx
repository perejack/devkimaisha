...
import heroImage from "@/assets/BOX PROFILE.jpg";

const Hero = () => {
  const features = [
    {
      icon: Shield,
      title: "Premium Steel & Mabati",
      description: "KEBS certified steel bars and weather-resistant mabati roofing"
    },
    {
      icon: Zap,
      title: "25-Year Warranty",
      description: "Long-lasting mabati products with industry-leading warranties"
    },
    {
      icon: Award,
      title: "Complete Solutions",
      description: "From foundation steel to roofing - your one-stop construction partner"
    }
  ];
